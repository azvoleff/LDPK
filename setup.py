...
setup(
    ...
    entry_points = {'console_scripts': ['teampy_preprocess = teampy.preprocess_image.py:main',
                                        'teampy_classify = teampy.classify_image:main',
                                        'teampy_analyze = teampy.analyze_classification:main']},
    zip_safe = True,
